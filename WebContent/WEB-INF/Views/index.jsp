		...
		<div class="row">
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
				<div class="card" style="height: 200px">
					...
					<img src="<spring:url value='/resources/img/stay-online.png' />"
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="card" style="height: 200px">
					...
					<img src="<spring:url value='/resources/img/stay-phone.png' />"
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="card" style="height: 200px">
					...
					<img src="<spring:url value='/resources/img/stay-social.png' />" 
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="card" style="height: 200px">
					...
					<img src="<spring:url value='/resources/img/stay-watch.png' />" 
